...
export const tasks: Task[] = [
    ...
    { id: '8', name: 'Vacuum or sweeptside', points: 10, time: '12:00 am', priority: 'Medium', isAdditional: true },
    { id: '9', name: 'Clean windows from the outside', points: 20, time: '11:00 am', priority: 'High', isAdditional: true },
  ];